...
//uint16_t input_start_x;    // The lowest number of the range input.
//uint16_t input_end_x;    // The largest number of the range input.
//uint16_t input_start_y;    // The lowest number of the range input.
//uint16_t input_end_y;    // The largest number of the range input.
//uint16_t output_start_x; // The lowest number of the range output.
//uint16_t output_end_x;  // The largest number of the range output
//uint16_t output_start_y; // The lowest number of the range output.
//uint16_t output_end_y;  // The largest number of the range output
//double slope_x;
//double slope_y;
